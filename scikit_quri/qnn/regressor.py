...
class QNNRegressor:
    ...
    def cost_fn(self,x_scaled:NDArray[np.float_],y_scaled:NDArray[np.float_], params: Sequence[float]) -> float:
        """
    ...
    def grad_fn(self, x_scaled:NDArray[np.float_], y_scaled:NDArray[np.float_] ,params: Sequence[Sequence[float]]) -> NDArray[np.float_]:
        """
