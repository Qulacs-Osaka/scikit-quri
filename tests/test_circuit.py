...
def test_parametric_gate() -> None:
    ...
    params = circuit.generate_bound_params([0.1], [0.2])
...
def test_parametric_input_gate() -> None:
    ...
    params = circuit.generate_bound_params([1.0], [])
...
def test_parametric_gates_mixed() -> None:
    ...
    params = circuit.generate_bound_params([1.0], [0.1, 0.5, 0])
    assert np.array_equal(params, np.array([0.1, 1.5, 0]))
    params = circuit.generate_bound_params([1.0], [0.2, 1.0, 0])
...
def test_share_learning_parameter() -> None:
    ...
    params = circuit.generate_bound_params([], [0.1])
...
def test_running_shared_parameter() -> None:
    ...
    params = circuit.generate_bound_params([], [0.0])
    ...
    params = circuit.generate_bound_params([], [0.1])
    params_without_share = circuit_without_share.generate_bound_params([], [0.1, 0.1])
...
def test_share_coef_input_learning_parameter() -> None:
    ...
    circuit_without_share.add_parametric_RX_gate(0)
    circuit_without_share.add_parametric_RY_gate(1)
    params_circuit_without_share = circuit_without_share.generate_bound_params([], [0.1, 0.2, 0.4])
